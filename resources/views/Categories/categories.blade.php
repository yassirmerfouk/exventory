<x-layout>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row" style="margin-bottom: 10px;">
                <div class="col">
                    @can('category_add')
                        <a href="{{ route('categoryAddPage') }}"><button type="button"
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('categoryUpadatePage', $category->id) }}"><button
    ...
    @section('script')
        ...
        @if (session()->has('Add'))
            <script>
                swal("Category Add", "{!! session()->get('Add') !!}", "success", {})

            </script>
        @endif
        @if (session()->has('Update'))
            <script>
                swal("Category Update", "{!! session()->get('Update') !!}", "success", {})

            </script>
        @endif
        @if (session()->has('Delete'))
            <script>
                swal("Category Delete", "{!! session()->get('Delete') !!}", "success", {})
