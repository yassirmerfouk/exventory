<x-layout>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row" style="margin-bottom: 10px;">
                <div class="col">
                    <a href="{{ route('roleAddPage') }}"><button type="button"
                        ...
                        @foreach ($roles as $role)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('roleUpdatePage', $role->id) }}"><button
    ...
    @section('script')
        ...
        @if (session()->has('Add'))
            <script>
                swal("Role Add", "{!! session()->get('Add') !!}", "success", {})

            </script>
        @endif
        @if (session()->has('Update'))
            <script>
                swal("Role Update", "{!! session()->get('Update') !!}", "success", {})

            </script>
        @endif
        @if (session()->has('Delete'))
            <script>
                swal("Role Delete", "{!! session()->get('Delete') !!}", "success", {})
