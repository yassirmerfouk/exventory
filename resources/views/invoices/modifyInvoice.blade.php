    ...
    @section('css')
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Modify Invoice</h3>
            ...
            <div class="card-body">
                <form action="{{ route('invoiceUpdate', $invoice->id) }}" method="POST" name="addInvoice"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('client_name') is-invalid @enderror"
                                name="client_name" value="{{ $invoice->client_name }}" placeholder="Client Name">
                            @error('client_name')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control @error('client_phone') is-invalid @enderror"
                                name="client_phone" value="{{ $invoice->client_phone }}" placeholder="Client Phone">
                            @error('client_phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control  @error('date') is-invalid @enderror" type="date"
                                value="{{ $invoice->date }}" name="date" readonly>
                            @error('date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('client_address') is-invalid @enderror"
                                name="client_address" value="{{ $invoice->client_address }}" placeholder="Client Address">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control @error('quantity') is-invalid @enderror"
                                    value="{{ $product->pivot->quantity }}" name="quantity[]" placeholder="quantity">
                                @error('quantity')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
